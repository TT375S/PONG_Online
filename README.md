...
* 特別に契約して固定IPにして家のIPアドレスをDNSに登録
* DDNSに定期的に家のIPアドレスを登録
などしてない限りホスト名から名前解決できません。家庭内で接続するとしても、家でネームサーバーは立ててないと思うし...

なので、ホスト名から引くのではなく、IPアドレスを直打ちして繋ぐというふうに変更した方がいいかもしれません(繋ぐ時はルータの設定とかがやっぱり必要だと思うけど...)
